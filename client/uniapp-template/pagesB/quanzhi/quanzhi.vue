	...
	<view id="moments">
		...
		<view class="home-pic">
			<view class="home-pic-base">
				<view class="top-pic">
					<image class="header" :src='headImg' @tap="changeHead"></image>
					<!-- <image class="portrait" :src='headImg'></image>	 -->
				</view>
				<view class="top-name">{{nickname || '未设置昵称'}}</view>
			</view>
		</view>
	...
	export default {
		...
		data() {
			return {
				...
				qiniu:'',//七牛云
				phnoeNumber:'',
				headImg:'../../static/index/test/header06.jpg',
				nickname: ''
			}
		},
		mounted() {
			...
			ef.submit({
					...
					callback: function(data) {
						uni.hideLoading();
						var dataList = fns.checkError(data, ['user','config'], function(errNo, error) {
