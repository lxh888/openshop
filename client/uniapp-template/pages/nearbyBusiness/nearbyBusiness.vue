<template>
	<view class="content">
		...
		<view class="getPosition" >
			<image src="http://muyingshop.eonfox.com/icon/position.png" @click="toAddressList()" style="width: 50upx;height: 50upx;" mode=""></image>
			<text @click="toAddressList()" v-if="Address" >{{Address.details}}</text>
			<text @click="toAddressList()" v-else >选择地址</text>
		</view>
		<!-- 头部 -->
