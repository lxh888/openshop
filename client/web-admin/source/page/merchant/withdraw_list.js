WangAho({
	...
	main : function(){
		...
		var request = {application_config:["APPLICATIONCONFIG"], list:["MERCHANTADMINWITHDRAWLIST", [config]]};
		...
		WangAho("index").data({
			...
			success : function(data){
				...
				WangAho("index").view(WangAho().template("page/merchant/withdraw_list.html", "#content"), data, {
		...
		$(".search").unbind("click").click(function(){
			...
			layer.open({
				title : "<span class=\"glyphicon glyphicon-filter\"></span> 筛选",
			  	...
			  	content: template( WangAho().template("page/merchant/withdraw_list.html", "#search"), function(fn){
