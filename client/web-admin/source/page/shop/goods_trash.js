WangAho({
	...
	main : function(){
		...
		WangAho("index").data({
			request : {
				list:["SHOPADMINGOODSTRASHLIST", [config]]
			},
			success : function(data){
				...
				WangAho("index").view(WangAho().template("page/shop/goods_trash.html", "#content"), data);
				_project.event();
	...
	restore : function(ids){
		...
		var request_array = [];
		for(var i in ids){
			request_array.push(["SHOPADMINGOODSTRASHRESTORE", [{shop_goods_id:ids[i]}]]);
		}
