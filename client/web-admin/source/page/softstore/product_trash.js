	...
	main : function(){
		...
		WangAho("index").data({
			request : {
				...
				list:["SOFTSTOREADMINPRODUCTTRASHLIST", [config]]
			},
			success : function(data){
				...
				WangAho("index").view(WangAho().template("page/softstore/product_trash.html", "#content"), data);
				_project.event();
