av({
	...
	data:{
		...
		eventSubmit:function(){
			...
			var form_input = {};
			var form_data = {};
			form_input.type_id = this.typeData.type_id;
			...
			this.submit({
				method:"submit",
				request:["APPLICATIONADMINTYPEEDIT", [form_input]],
				data : form_data,	
