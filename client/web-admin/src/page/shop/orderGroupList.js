av({
	id: 'page-shop-orderGroupList', //工程ID
	...
	'export': {
		template: "src/page/shop/orderGroupList.html",
	},
	'import': function(e) {
	...
	main: function() {
		...
		this.data.request.list = ['SHOPADMINORDERGROUPLIST', [config]];
		...
		if( this.data.applicationCheckYouli() ){
			...
			this.data.search.push('user_officer_name', 'write_off_user_phone');
		}
